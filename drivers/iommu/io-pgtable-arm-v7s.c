 ...
 */
static __noipa void dummy_tlb_flush_all(void *cookie)
{
	WARN_ON(cookie != cfg_cookie);
}

static __noipa void dummy_tlb_flush(unsigned long iova, size_t size, size_t granule,
			    void *cookie)
{
	WARN_ON(cookie != cfg_cookie);
...
static __noipa void dummy_tlb_add_page(struct iommu_iotlb_gather *gather,
